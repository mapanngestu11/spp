...
<html class="fixed">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Data Siswa Kelas XII</span></li>
							</ol>
 ...
 ?>				<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Data Siswa Kelas XII</h2>
							</header>
							<div class="panel-body">
								<a class="modal-with-form btn btn-primary" href="#modalForm"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</a>
								<a href="list.data.kelas.xii.php" id="portletRefresh" type="button" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-refresh"></i> Refresh</a>
								<br>
								...
								<div id="modalForm" class="modal-block modal-block-primary mfp-hide">
										<section class="panel">
											...
											<div class="panel-body">
											<form  action="crud/add.siswa.kelas.xii.php" method="post" id="demo-form" class="form-horizontal mb-lg" novalidate="novalidate" enctype="multipart/form-data">
													<div class="form-group mt-lg">
														<label class="col-sm-3 control-label">Nama</label>
														<div class="col-sm-9">
															<input type="text" name="nama_siswa" class="form-control" placeholder="Nama Lengkap" required/>
															<input type="hidden" name="kelas" class="form-control" value="XII"  />
														</div>
													</div>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbl_kelas where kelas = 'XII'"); 
		while($d = mysqli_fetch_array($data)){
			?>
										<tr class="gradeX">
											...
											<td align="center"><a onclick="if(confirm('Apakah anda yakin ingin mengubah data ini ?')){ location.href='detail.kelas.xii.php?id_kelas=<?php echo $d['id_kelas']; ?>' }" class="btn btn-round btn-warning"><i class="fa fa-pencil"></i></a></td>
											<td align="center"><a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ?')){ location.href='crud/hapus.siswa.kelas.xii.php?id_kelas=<?php echo $d['id_kelas']; ?>' }" class="btn btn-round btn-danger"><i class="fa fa-trash-o"></i></a></td>
										</tr>
